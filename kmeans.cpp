...
BYTE *dataBuf = JpegFile::JpegFileToRGB("bigben.jpg", &width, &height);  // reading image
BYTE *dataBuf2 = JpegFile::JpegFileToRGB("bigben.jpg", &width, &height); // reading image that will become our altered image
...
int main()
{
	...
	// made k = 50 for parallelization to see a almost expected speed up and relatively complete image other than the sky
	int k = 50;
...
#pragma omp critical
	...
	JpegFile::RGBToJpegFile("bigbenkmean.jpg", dataBuf2, width, height, true, 75);
